...
average_score_in_category = func(movies, category_input)
print(f"The average IMDB score in the category '{category_input}' is: {average_score_in_category:.2f}")
